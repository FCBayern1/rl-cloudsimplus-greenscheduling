...
\begin{table}[ht]
\caption{Carbon per completed work under sampling-based decoding, clean forecasts. All runs complete at least 99.6\% of the workload, so no cell is completion-deflated. Vanilla and EU-CRD are medians over three seeds; baselines use one seed.}
