...
% fragility claim. It stays true until the grading in reports/APPF_PREREG.md
% is executed. Turning it off is a required pre-submission step.
\newif\ifFragileUnresolved \FragileUnresolvedtrue
...
\ResFragileCount{}\FragTag{} over-defers under greedy decoding in both arms, a property of the training recipe
