#!/usr/bin/env python3
"""
Entry point for Multi-Datacenter Training with gMLP RLModule (RLlib New API Stack).

Usage:
  python entrypoint_rlmodule_gmlp.py --experiment experiment_multi_dc_5
"""
...
logger = logging.getLogger("gMLPEntrypoint")
...
def main():
    parser = argparse.ArgumentParser(description="Train Multi-DC agents with gMLP RLModule (RLlib New API)")
    ...
    from src.training.train_rlmodule_gmlp import train_rlmodule_gmlp, load_config
    ...
    if args.output_dir is not None:
        ...
        output_dir = project_root / "logs" / f"{args.experiment}_gMLP_RLModule" / timestamp
